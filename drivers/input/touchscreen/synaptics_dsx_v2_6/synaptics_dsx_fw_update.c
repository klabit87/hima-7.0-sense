...
#ifdef CONFIG_TOUCHSCREEN_SYNAPTICS_DSX_FW_UPDATE_SYSFS_V2_6
...
static void fwu_startup_fw_update_work(struct work_struct *work)
{
	...
	mutex_lock(&fwu_sysfs_mutex_v2_6);
#endif
...
#if defined(CONFIG_TOUCHSCREEN_SYNAPTICS_DSX_FW_UPDATE_SYSFS_V2_6) || \
